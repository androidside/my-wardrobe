...
import { ClothingItem, FOOTWEAR_TYPES } from '@/types/clothing';
                ...
                <Card className="p-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 truncate">{outfit.top.type} - {outfit.top.color}</p>
                    </div>
                    <Button
                      variant="ghost"
                      size="icon"
                ...
                <Card className="p-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 truncate">{outfit.bottom.type} - {outfit.bottom.color}</p>
                    </div>
                    <Button
                      variant="ghost"
                      size="icon"
                ...
                <Card className="p-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 truncate">{outfit.footwear.type} - {outfit.footwear.color}</p>
                    </div>
                    <Button
                      variant="ghost"
                      size="icon"
                  ...
                  <Card key={accessory.id} className="p-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 truncate">{accessory.type} - {accessory.color}</p>
                      </div>
                      <Button
                        variant="ghost"
                        size="icon"
